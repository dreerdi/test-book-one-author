...
<table class="table table-striped table-bordered">
	...
	<?php foreach ($books as $key => $value): ?>
		<tr id="tr<?php echo $value['book_id']; ?>">
			...
			<td class="text-center">
				<a href="/books/edit/<?php echo $value['book_id']; ?>/" title="Редактировать запись">
					<span class="glyphicon glyphicon-pencil"></span>
				</a>
				<span>  /  </span>
				<a class="deleteBook" href="/books/delete/<?php echo $value['book_id']; ?>/" title="Удалить запись">
				<span class="glyphicon glyphicon-trash" id="<?php echo $value['book_id']; ?>"></span>
				</a>
			</td>
		</tr>
	<?php endforeach ?>
